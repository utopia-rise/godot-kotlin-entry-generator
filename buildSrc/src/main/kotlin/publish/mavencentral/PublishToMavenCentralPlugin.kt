                ...
                publications {
                    all {
                        if (this is MavenPublication) {
                            ...
                            pom {
                                url.set("https://github.com/utopia-rise/godot-kotlin-entry-generator.git")

                                scm {
                                    connection.set("scm:git:https://github.com/utopia-rise/godot-kotlin-entry-generator")
                                    developerConnection.set("scm:git:github.com:utopia-rise/godot-kotlin-entry-generator.git")
                                    tag.set("master") //FIXME
                                    url.set("https://github.com/utopia-rise/godot-kotlin-entry-generator")
                                }

                                licenses {
                                    license {
                                        name.set("MIT License")
                                        url.set("https://github.com/utopia-rise/godot-kotlin-entry-generator/blob/master/LICENSE")
